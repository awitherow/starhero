...
export class Boot extends Phaser.State {
    preload() {
        ...
        this.game.load.image(
            'ground-festive',
            'assets/env/ground-wide-festive.png',
        );
        ...
        this.game.load.spritesheet(
            'dude',
            'assets/char/player/dude.png',
            32,
            48,
        );
        this.game.load.spritesheet(
            'guy-festive',
            'assets/char/player/guy-festive.png',
            44,
            44,
        );
        this.game.load.spritesheet(
            'baddie',
            'assets/char/baddies/baddie.png',
            32,
            32,
        );
        ...
        this.game.load.spritesheet(
            'bomb',
            'assets/weapons/hankies_rotate.png',
            24,
            24,
        );
        this.game.load.spritesheet(
            'explosion',
            'assets/weapons/explode.png',
            128,
            128,
        );
    }
